...
namespace TravelTrack_API.Migrations
{
    ...
    [Migration("20230125191701_AddPhotosSetAndSeedData")]
    partial class AddPhotosSetAndSeedData
    {
            ...
            modelBuilder.Entity("TravelTrack_API.Domain.Photo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c25e28d6-7069-4aaa-b5a0-088fb46604a8"),
                        ...
                        new
                        {
                            Id = new Guid("2a663dcd-60ac-409a-9ec8-14ac915aa1af"),
                            AddedByUser = "jmoran@ceiamerica.com",
